...
console.log('=========================================');
console.log('[Marketplace de artesanías colombianas] - FICHA DE PRESENTACIÓN');
console.log('=========================================');
console.log('');
...
console.log('Categoría:       [E-commerce y retail]');
...
console.log('Valor calculado:    ', 85000 * 0.9); // TODO: reemplaza 0 con tu cálculo
...
console.log('[Descubre y apoya el talento artesanal colombiano!]');
